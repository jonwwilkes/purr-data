...
const l = pdbundle.pdgui.get_local_string; // For menu names
let prev_menu_clicked;

function menu_section_click(id) {
    // Hide previous menu clicked
    if (prev_menu_clicked !== undefined) {
        const prev = document.getElementById(prev_menu_clicked);
        if (prev) {
    ...
    const m_option = document.getElementById(id);
...
function menu_options(type, w, cid) {
    ...
    const file_base = {
        ...
        'menu-file': {
            label: l('menu.file'),
            action: {
                onclick() { menu_section_click('menu-file' + cid); },
                onmousemove() { menu_section_move('menu-file' + cid); },
        },
    },
    ...
    const edit_base = {
        ...
        'menu-edit': {
            label: l('menu.edit'),
            action: {
                onclick() { menu_section_click('menu-edit' + cid); },
                onmousemove() { menu_section_move('menu-edit' + cid); },
            },
        },
    ...
    const view_base = {
        ...
        'menu-view': {
            label: l('menu.view'),
            action: {
                onclick() { menu_section_click('menu-view' + cid); },
                onmousemove() { menu_section_move('menu-view' + cid); },
       },
    },
    ...
    const window_base = {
        ...
        'menu-window': {
            ...
            action: {
                onclick() { menu_section_click('menu-window' + cid); },
                onmousemove() { menu_section_move('menu-window' + cid); },
        },
     },

        // Window entries
        'window-nextwin': {
            action: { onclick() { pdbundle.pdgui.raise_next('pd_window'); } },
        ...
        'window-prevwin': {
            action: { onclick() { pdbundle.pdgui.raise_prev('pd_window'); } },
    ...
    const console_menu_base = {
        ...
        'menu-media': {
            label: l('menu.media'),
            action: {
                onclick() { menu_section_click('menu-media' + cid); },
                onmousemove() { menu_section_move('menu-media' + cid); },
        },
     },

        // Media entries
        'media-audio-on': {
            action: { onclick() { pdbundle.pdgui.pdsend('pd dsp 1'); } },
        ...
        'media-audio-off': {
            action: { onclick() { pdbundle.pdgui.pdsend('pd dsp 0'); } },
        ...
        'media-test': {
            action: { onclick() { pdbundle.pdgui.pd_doc_open('doc/7.stuff/tools', 'testtone.pd'); } },
            label: l('menu.test'),
            tooltip: l('menu.test_tt'),
        },
        'media-loadmeter': {
            action: { onclick() { pdbundle.pdgui.pd_doc_open('doc/7.stuff/tools', 'load-meter.pd'); } },
        ...
        'menu-help': {
            label: l('menu.help'),
            action: {
                onclick() { menu_section_click('menu-help' + cid); },
                onmousemove() { menu_section_move('menu-help' + cid); },
        },
     },

        // Help entries
        'help-about': {
            action: { onclick() { pdbundle.pdgui.web_pd_doc_open('doc/about', 'about.pd'); } },
            label: l('menu.about'),
            tooltip: l('menu.about_tt'),
        },
        'help-manual': {
            action: { onclick() { pdbundle.pdgui.pd_doc_open('doc/1.manual', 'index.htm'); } },
            label: l('menu.manual'),
        ...
        'help-intro': {
            action: { onclick() { pdbundle.pdgui.pd_doc_open('doc/5.reference', 'help-intro.pd'); } },
            label: l('menu.intro'),
            tooltip: l('menu.intro_tt'),
            bottom_hr: {},
        },
        'help-l2ork-list': {
            action: { onclick() { pdbundle.pdgui.external_doc_open('http://disis.music.vt.edu/listinfo/l2ork-dev'); } },
            label: l('menu.l2ork_list'),
            tooltip: l('menu.l2ork_list_tt'),
        },
        'help-pd-list': {
            action: { onclick() { pdbundle.pdgui.external_doc_open('http://puredata.info/community/lists'); } },
            label: l('menu.pd_list'),
            tooltip: l('menu.pd_list_tt'),
        },
        'help-forums': {
            action: { onclick() { pdbundle.pdgui.external_doc_open('http://forum.pdpatchrepo.info/'); } },
            label: l('menu.forums'),
            tooltip: l('menu.forums_tt'),
        },
        'help-irc': {
            action: { onclick() { pdbundle.pdgui.external_doc_open('http://puredata.info/community/IRC'); } },
            label: l('menu.irc'),
    ...
    const canvas_menu_base = {
        ...
        'edit-finderror': {
            action: { onclick() { pdbundle.pdgui.pdsend('pd finderror'); } },
        ...
        'menu-put': {
            label: l('menu.put'),
            action: {
                onclick() { menu_section_click('menu-put' + cid); },
                onmousemove() { menu_section_move('menu-put' + cid); },
            },
        },
        ...
        'window-pdwin': {
            action: { onclick() { pdbundle.pdgui.raise_pd_window(); } },
            label: l('menu.pdwin'),
    ...
    for (const id in menu) {
        const menu_item = w.document.getElementById(id + cid);
        visible(menu_item);
...
window.modifiers = function (menu_item, modifiers) {
    const shortkey = modifiers + '+' + tmp_key;
